    ...
    <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
            ...
            <td style="background:linear-gradient(135deg,#1a0a2e 0%,#0d0d1a 50%,#0a1a1a 100%);border-radius:20px 20px 0 0;overflow:hidden;">
                ...
                <div style="padding:40px 40px 20px;text-align:center;">
                    ...
                    {{-- <img src="{{ $message->embed(public_path('images/logo.png')) }}"
                         alt="Initium 2026"
                         width="80"
                         style="width:80px;height:auto;margin:0 auto 20px;display:block;"
                         onerror="this.style.display='none'"> --}}

                    <p style="margin:0;font-size:52px;letter-spacing:10px;color:#FFD700;font-weight:900;text-transform:uppercase;line-height:1;text-shadow:0 0 40px rgba(255,215,0,0.5);">INITIUM</p>
                ...
                <div style="padding:0 40px;">
                    <div style="border-radius:14px;overflow:hidden;border:1px solid rgba(255,0,128,0.25);">
                        <img src="{{ asset('storage/' . $registration->event->banner_image) }}"
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="50%" style="padding-bottom:20px;vertical-align:top;">
                                                <p style="margin:0 0 5px;font-size:10px;letter-spacing:3px;color:rgba(255,255,255,0.3);text-transform:uppercase;">Name</p>
                                                <p style="margin:0;font-size:18px;color:#fff;font-weight:700;">{{ $registration->participants->first()->name }}</p>
                                            </td>
                                            <td width="50%" style="padding-bottom:20px;vertical-align:top;">
                                                <p style="margin:0 0 5px;font-size:10px;letter-spacing:3px;color:rgba(255,255,255,0.3);text-transform:uppercase;">Student ID</p>
                                                <p style="margin:0;font-size:18px;color:#fff;font-weight:700;">{{ $registration->participants->first()->student_id }}</p>
                                            </td>
                                        </tr>
                                    </table>
                                @else
                                    <p style="margin:0 0 5px;font-size:10px;letter-spacing:3px;color:rgba(255,255,255,0.3);text-transform:uppercase;">Team Name</p>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:10px;">
                                        <tr>
                                            <td width="30" style="vertical-align:middle;">
                                                <div style="width:24px;height:24px;border-radius:50%;background:rgba(255,0,128,0.15);border:1px solid rgba(255,0,128,0.4);text-align:center;line-height:24px;font-size:11px;color:#FF0080;font-weight:700;">{{ $i+1 }}</div>
                                            </td>
                                            <td style="padding-left:10px;vertical-align:middle;">
                                                <p style="margin:0;font-size:16px;color:#fff;font-weight:600;">{{ $member->name }}</p>
                                                <p style="margin:2px 0 0;font-size:12px;color:rgba(255,255,255,0.4);">{{ $member->student_id }}</p>
                                            </td>
                                        </tr>
                                    </table>
                                    @endforeach
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="50%" style="padding-bottom:16px;vertical-align:top;">
                                            <p style="margin:0 0 5px;font-size:10px;letter-spacing:3px;color:rgba(255,255,255,0.3);text-transform:uppercase;">College</p>
                                            <p style="margin:0;font-size:15px;color:#fff;font-weight:600;">{{ $registration->college_name }}</p>
                                        </td>
                                        <td width="50%" style="padding-bottom:16px;vertical-align:top;">
                                            <p style="margin:0 0 5px;font-size:10px;letter-spacing:3px;color:rgba(255,255,255,0.3);text-transform:uppercase;">Registration Type</p>
                                            <p style="margin:0;font-size:15px;color:#fff;font-weight:600;">{{ ucfirst($registration->registration_type) }}</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="50%" style="vertical-align:top;">
                                            <p style="margin:0 0 5px;font-size:10px;letter-spacing:3px;color:rgba(255,255,255,0.3);text-transform:uppercase;">Email</p>
                                            <p style="margin:0;font-size:14px;color:#00F5FF;">{{ $registration->contact_email }}</p>
                                        </td>
                                        <td width="50%" style="vertical-align:top;">
                                            <p style="margin:0 0 5px;font-size:10px;letter-spacing:3px;color:rgba(255,255,255,0.3);text-transform:uppercase;">Phone</p>
        ...
        <tr>
            <td style="background:#0f0f18;padding:16px 24px 0;">
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="50%" style="background:rgba(0,245,255,0.05);border:1px solid rgba(0,245,255,0.25);border-radius:16px;padding:24px;text-align:center;vertical-align:middle;">
                            ...
                            <p style="margin:0;font-size:36px;color:#00F5FF;font-weight:900;">₹{{ number_format($registration->event->price, 0) }}</p>
                            <p style="margin:8px 0 0;font-size:10px;letter-spacing:3px;color:rgba(0,245,255,0.55);text-transform:uppercase;">Confirmed ✓</p>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        {{-- ── VENUE ── --}}
        <tr>
            <td style="background:#0f0f18;padding:16px 24px 24px;">
                <table width="100%" cellpadding="0" cellspacing="0" style="background:linear-gradient(135deg,rgba(255,0,128,0.06),rgba(124,58,237,0.06));border:1px solid rgba(255,255,255,0.07);border-radius:16px;">
                    <tr>
                        <td style="padding:28px;text-align:center;">
                            ...
                            <p style="margin:0 0 4px;font-size:18px;color:#fff;font-weight:700;">New Horizon College of Engineering</p>
                            <p style="margin:0 0 16px;font-size:13px;color:rgba(255,255,255,0.45);">Outer Ring Road, Bengaluru — 560103</p>
                            <div style="display:inline-block;background:rgba(255,215,0,0.08);border:1px solid rgba(255,215,0,0.3);border-radius:50px;padding:10px 28px;">
                                <p style="margin:0;font-size:14px;color:#FFD700;font-weight:700;letter-spacing:3px;">MAY 20, 2026</p>
                            </div>
                        </td>
                    </tr>
                </table>
        ...
        {{-- ── FOOTER ── --}}
        <tr>
            <td style="background:linear-gradient(135deg,#1a0a2e 0%,#0d0d1a 100%);border-radius:0 0 20px 20px;overflow:hidden;">
                ...
                <div style="padding:28px 40px;text-align:center;">
                    ...
                    <p style="margin:0 0 16px;font-size:13px;color:#00F5FF;">websupport@newhorizoncollegeofengineering.in</p>

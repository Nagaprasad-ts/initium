...
function EventCard({ event, index }: { event: Event; index: number }) {
    ...
    return (
        <div
            ref={ref}
            className="rv-in relative flex cursor-pointer flex-col overflow-hidden rounded-2xl border border-white/8 bg-white/3 transition-all duration-300"
            onMouseEnter={(e) => {
        ...
        >
            <Link href={`/events/${event.slug}`}>
                ...
                <div className="relative h-52 shrink-0 overflow-hidden bg-black/50">
                    {event.banner_image_events_page ? (
                        ...
                        <div
                            ...
                            style={{
                                background: `linear-gradient(135deg, ${color}1A 0%, rgba(0,0,0,0.7) 100%)`,
                            }}
                        >
                ...
                <div className="flex flex-1 flex-col px-6 pt-5 pb-6">
                    {/* Category */}
                    <p
                        className="font-orbitron mb-1.5 text-[10px] tracking-[3px] uppercase"
                    ...
                    {/* Meta row 2 */}
                    <div className="font-rajdhani my-2 flex flex-wrap items-center gap-2 text-sm font-medium text-white/70">
                    ...
                    <div className="mt-auto flex items-center justify-between border-t border-white/8 pt-5">
                        <div>
                            <p className="font-orbitron mb-0.5 text-[9px] tracking-[2px] text-white/40 uppercase">
                                Entry Fee
                            </p>
                            <p
                                className="font-bebas text-[26px] leading-none tracking-wide"
                                style={{ color }}
                            >
...
export default function Index({
    ...
    const filtered =
        active === 'all'
            ? events
            : events.filter((e) => e.category_id === active);
    const activeCatName =
        active !== 'all'
            ? formatCategoryName(
    ...
    return (
        <Layout>
            ...
            <section
                ...
                style={{
                    background:
                        'radial-gradient(ellipse 70% 50% at 50% 0%, rgba(255,0,128,0.13) 0%, transparent 70%)',
                }}
            >
                <p
                ...
                >
                    ...
                    <span
                        style={{
                            color: '#FF0080',
                            textShadow: '0 0 40px rgba(255,0,128,.6)',
                        }}
                    >
                        EVENTS
                    </span>
                ...
                <div className="mx-auto my-4 flex max-w-50 items-center gap-3">
                    <div
                        ...
                        style={{
                            background:
                                'linear-gradient(to left, #FF0080, transparent)',
                        }}
                    />
                    <div
                    ...
                    <div
                        ...
                        style={{
                            background:
                                'linear-gradient(to right, #FF0080, transparent)',
                        }}
                    />
                </div>
            ...
            >
                <div
                    className="flex items-center gap-2 overflow-x-auto px-4 py-3 md:flex-wrap md:justify-center md:px-5 md:py-3.5"
                    ...
                    {categories.map((cat) => {
                        ...
                        return (
                            <FilterTab
                                ...
                                count={count}
                                color={
                                    CATEGORY_COLORS[cat.name] ?? DEFAULT_COLOR
                                }
            ...
            {/* ═══ GRID ═══ */}
            <main className="mx-auto max-w-300 px-5 pt-12 pb-24">
                {/* Context label */}
                <div className="mb-10 flex items-center gap-4">
                    <div className="h-px flex-1 bg-white/6" />
                    <p
                        className="font-orbitron whitespace-nowrap text-white/40 uppercase"
                ...
                {filtered.length > 0 ? (
                    ...
                    <div className="rounded-2xl border border-dashed border-white/8 px-5 py-20 text-center">
                        ...
                        <p className="font-rajdhani mt-2 text-[15px] text-white/18">
